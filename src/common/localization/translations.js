...
const directTranslations = {
  en: {
    ...
    'common.all_versions': 'All Versions',
    'common.select_version': 'Select a version',
    'common.current_version': 'Current version',
    'common.loading_updates': 'Loading updates...',
    'common.change_version': 'Change version',
    'common.install': 'Install',
    'common.sorting': 'Sorting',
    'common.author_with_colon': 'Author: ',
    'common.downloads_with_colon': 'Downloads: ',
    'common.updated_with_colon': 'Updated: ',
    'minecraft.version': 'Minecraft Version',
    'minecraft.version_with_colon': 'Minecraft Version: ',
    'categories.placeholder': 'Category',
    'categories.minecraft': 'Minecraft Category',
    'categories.all': 'All Categories',
    'mods.update_all': 'Update All Mods',
    'mods.add_mod': 'Add Mod',
    'mods.items.mods': 'mods',
    'mods.not_found': 'No mods found :c',
    'mods.not_found_with_filters':
      'No mods have been found with the current filters.',
    'mods.loading_error': 'An error occurred while loading the mods list...',
    'modpacks.not_found_with_filters':
      'Nothing matched the selected filters...',
    'modpacks.loading_error':
      'An error occurred while loading the mods list...',
    'resourcepacks.add': 'Add Resource Pack',
    'resourcepacks.not_found': 'No resource packs found :c',
    'discord.curseforge.modpacks': 'Browsing CurseForge modpacks',
    'notes.placeholder': 'Enter something...',
    ...
    'settings.sort.custom': 'Custom Order',
  ...
  ru: {
    ...
    'common.no_updates': 'Нет обновлений',
    'common.confirmation': 'Подтверждение',
    'common.confirm': 'Подтвердить',
    'common.search': 'Поиск...',
    'common.search_among': 'Поиск среди',
    'common.sort': 'Сортировать',
    'common.featured': 'Рекомендуемые',
    'common.popularity': 'Популярные',
    'common.last_updated': 'Последние обновления',
    'common.updated': 'Обновлённые',
    'common.author': 'Автор',
    'common.name': 'Название',
    'common.downloads': 'Загрузки',
    'common.relevance': 'Релевантность',
    'common.follows': 'Подписки',
    'common.newest': 'Новые',
    'common.all_versions': 'Все версии',
    'common.select_version': 'Выберите версию',
    'common.current_version': 'Текущая версия',
    'common.loading_updates': 'Загрузка обновлений...',
    'common.change_version': 'Изменить версию',
    'common.install': 'Установить',
    'common.sorting': 'Сортировка',
    'common.author_with_colon': 'Автор: ',
    'common.downloads_with_colon': 'Загрузки: ',
    'common.updated_with_colon': 'Обновлено: ',
    'minecraft.version': 'Версия Minecraft',
    'minecraft.version_with_colon': 'Версия Minecraft: ',
    'categories.placeholder': 'Категория',
    'categories.minecraft': 'Категория Minecraft',
    'categories.all': 'Все категории',
    'mods.update_all': 'Обновить все моды',
    'mods.add_mod': 'Добавить мод',
    'mods.items.mods': 'модификаций',
    'mods.not_found': 'Модификации не найдены :с',
    'mods.not_found_with_filters':
      'По текущим фильтрам модификации не найдены.',
    'mods.loading_error':
    ...
    'modpacks.loading_error':
      'Произошла ошибка при загрузке списка модификаций...',
    'resourcepacks.add': 'Добавить ресурспак',
    'resourcepacks.not_found': 'Ресурспаки не найдены :с',
    'discord.curseforge.modpacks': 'Смотрит сборки CurseForge',
    'notes.placeholder': 'Введите что-нибудь...',
