module.exports = {
  new: [
    //{
      //header: 'Автоматическое обновление лаунчера',
  ...
  improvements: [
    {
      header: 'Обновлены библиотеки',
      content: 'запускатора лаунчера'
      // advanced: { cm: '8ec97baa' }
    },
    {
  ...
  bugfixes: [
    {
      header: 'Исправлено закрытие лаунчера',
      content: 'и перезапуск с ярлыка',
